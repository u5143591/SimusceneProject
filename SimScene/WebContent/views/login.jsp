...
<body>
<header class="pic"><img src="../img/banner1.png" alt=""></header>  
<form id="login" action= "checklogin.jsp" method="post">  
  <h1>登录</h1>  
    <fieldset id="inputs">  
        <input name="username" type="text" placeholder="用户名" required oninvalid="setCustomValidity('请输入用户名')">     
        <input name="password" type="password" placeholder="密码" required>  
    </fieldset>  
    <fieldset id="actions">  
        <input type="submit" id="submit" value="登录">  
        <a href="" onClick="ale()">忘记密码?</a>  
    </fieldset>   
</form>  
